...
export function ProjectCard({ project, locale }: { project: Project; locale: Locale }) {
  return (
    <article className="grid gap-7 border-t border-[var(--line)] py-8 md:grid-cols-[13rem_1fr]">
      ...
      <div>
        <div className="flex flex-wrap justify-between gap-3">
          <h3 className="text-2xl">{locale === "zh" ? project.titleZh : project.titleEn}</h3>
...
export function CompetitionCard({
  ...
  return (
    <article className="border-t border-[var(--line)] py-7">
      ...
      <h3 className="mt-4 text-2xl">{locale === "zh" ? competition.nameZh : competition.nameEn}</h3>
      {competition.cover && (
