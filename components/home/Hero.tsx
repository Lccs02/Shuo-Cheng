...
import { OrbitalAgentField } from "./OrbitalAgentField";

export function ProfilePhoto({ locale }: { locale: Locale }) {
  return (
    <div className="profile-frame relative aspect-[4/5] overflow-hidden border border-[var(--line)] bg-[var(--paper-deep)]">
      <ImageWithFallback
        src={profile.photo}
